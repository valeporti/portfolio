export default {
  ...
  messages: {
    ...
    Me1: 'Hello! :)',
    Me2: 'Developped software for business needs and done data analysis since my first career stage. In the begining of my career, I did ETL, and modeling to predict projects\' behavior and create decision making dashbord as tool for mangers. This software, the software I created to that end, was used in multiple projects of engineering and construction. And so, I got captivated by the power of software and decision making. ' 
